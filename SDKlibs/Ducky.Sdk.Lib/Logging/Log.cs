...
internal static class Log
{
    ...
    public static void Trace(Exception exception, string message, params object[] args) => Current.Trace(exception, message, args);
    public static void TraceFormat(string message, params object[] args) => Current.TraceFormat(message, args);
    public static void TraceException(string message, Exception exception) => Current.TraceException(message, exception);
    public static void TraceException(string message, Exception exception, params object[] args) => Current.TraceException(message, exception, args);
    ...
    public static void Debug(Exception exception, string message, params object[] args) => Current.Debug(exception, message, args);
    public static void DebugFormat(string message, params object[] args) => Current.DebugFormat(message, args);
    public static void DebugException(string message, Exception exception) => Current.DebugException(message, exception);
    public static void DebugException(string message, Exception exception, params object[] args) => Current.DebugException(message, exception, args);
    ...
    public static void Info(Exception exception, string message, params object[] args) => Current.Info(exception, message, args);
    ...
    public static void InfoException(string message, Exception exception, params object[] args) => Current.InfoException(message, exception, args);
    ...
    public static void Warn(Exception exception, string message, params object[] args) => Current.Warn(exception, message, args);
    ...
    public static void WarnException(string message, Exception exception, params object[] args) => Current.WarnException(message, exception, args);
    ...
    public static void Error(Exception exception, string message, params object[] args) => Current.Error(exception, message, args);
    public static void ErrorFormat(string message, params object[] args) => Current.ErrorFormat(message, args);
    public static void ErrorException(string message, Exception exception) => Current.ErrorException(message, exception);
    public static void ErrorException(string message, Exception exception, params object[] args) => Current.ErrorException(message, exception, args);
    ...
    public static void Fatal(Exception exception, string message, params object[] args) => Current.Fatal(exception, message, args);
    public static void FatalFormat(string message, params object[] args) => Current.FatalFormat(message, args);
    public static void FatalException(string message, Exception exception) => Current.FatalException(message, exception);
    public static void FatalException(string message, Exception exception, params object[] args) => Current.FatalException(message, exception, args);
