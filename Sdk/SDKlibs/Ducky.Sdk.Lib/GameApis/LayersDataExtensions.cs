...
public static class LayersDataExtensions
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GameplayDataSettings.LayersData SetDamageReceiverLayerMask(this GameplayDataSettings.LayersData target, LayerMask value) =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GameplayDataSettings.LayersData SetFowBlockLayers(this GameplayDataSettings.LayersData target, LayerMask value) =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GameplayDataSettings.LayersData SetFowBlockLayersWithThermal(this GameplayDataSettings.LayersData target, LayerMask value) =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GameplayDataSettings.LayersData SetGroundLayerMask(this GameplayDataSettings.LayersData target, LayerMask value) =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GameplayDataSettings.LayersData SetHalfObsticleLayer(this GameplayDataSettings.LayersData target, LayerMask value) =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GameplayDataSettings.LayersData SetWallLayerMask(this GameplayDataSettings.LayersData target, LayerMask value) =>
