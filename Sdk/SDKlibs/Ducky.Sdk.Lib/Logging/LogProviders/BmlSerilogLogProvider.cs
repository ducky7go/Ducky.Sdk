...
#endif
    internal class BmlSerilogLogProvider : LogProviderBase
    {
        private readonly Func<string, object> _getLoggerByNameDelegate;
        private static Func<string, object, bool, IDisposable> s_pushProperty;

        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly", MessageId = "Newbe.BetterModLoader")]
        public BmlSerilogLogProvider()
        {
        ...
        {
            var ndcContextType = FindType("Serilog.Context.LogContext", new[] {"Newbe.BetterModLoader", "Serilog.FullNetFx"});
        ...
        private static Type GetLogManagerType()
            => FindType("Serilog.Log", "Newbe.BetterModLoader");
    ...
    [ExcludeFromCodeCoverage]
        ...
        internal class SerilogLogger
        {
            ...
            private static bool Initialize()
            {
                try
                {
                    var logEventLevelType = FindType("Serilog.Events.LogEventLevel", "Newbe.BetterModLoader");
                    ...
                    var loggerType = FindType("Serilog.ILogger", "Newbe.BetterModLoader");
