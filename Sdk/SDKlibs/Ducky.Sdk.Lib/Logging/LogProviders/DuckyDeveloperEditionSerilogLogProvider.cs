...
#endif 
    internal class DuckyDeveloperEditionSerilogLogProvider : LogProviderBase 
    { 
    ...
    [ExcludeFromCodeCoverage] 
        ...
        { 
            ...
            { 
                try 
                { 
                    var logEventLevelType = FindType("Serilog.Events.LogEventLevel", "Ducky.Logging.DeveloperEdition"); 
                    ...
                    var loggerType = FindType("Serilog.ILogger", "Ducky.Logging.DeveloperEdition"); 
