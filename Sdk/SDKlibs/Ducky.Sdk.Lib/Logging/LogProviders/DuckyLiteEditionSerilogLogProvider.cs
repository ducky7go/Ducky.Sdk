...
#endif
    internal class DuckyLiteEditionSerilogLogProvider : LogProviderBase
    {
        private readonly Func<string, object> _getLoggerByNameDelegate;
        private static Func<string, object, bool, IDisposable> s_pushProperty;

        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly", MessageId = "Ducky.Logging.LiteEdition")]
        public DuckyLiteEditionSerilogLogProvider()
        {
        ...
        {
            var ndcContextType = FindType("Serilog.Context.LogContext", new[] {"Ducky.Logging.LiteEdition", "Serilog.FullNetFx"});
        ...
        private static Type GetLogManagerType()
            => FindType("Serilog.Log", "Ducky.Logging.LiteEdition");
    ...
    [ExcludeFromCodeCoverage]
        ...
        internal class SerilogLogger
        {
            ...
            private static bool Initialize()
            {
                try
                {
                    var logEventLevelType = FindType("Serilog.Events.LogEventLevel", "Ducky.Logging.LiteEdition");
                    ...
                    var loggerType = FindType("Serilog.ILogger", "Ducky.Logging.LiteEdition");
                    if (loggerType == null) throw new LibLogException("Type Serilog.ILogger was not found.");
                    var isEnabledMethodInfo = loggerType.GetMethod("IsEnabled", new[] { logEventLevelType });
                    ...
                    var writeMethodInfo =
                        loggerType.GetMethod("Write", new[] { logEventLevelType, typeof(string), typeof(object[]) });
                    ...
                    var writeExceptionMethodInfo = loggerType.GetMethod("Write",
                        new[] { logEventLevelType, typeof(Exception), typeof(string), typeof(object[]) });
