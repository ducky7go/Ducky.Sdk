...
#endif
    internal class DuckySerilogLogProvider : LogProviderBase
    {
        private readonly Func<string, object> _getLoggerByNameDelegate;
        private static Func<string, object, bool, IDisposable> s_pushProperty;

        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly", MessageId = "Ducky.Logging")]
        public DuckySerilogLogProvider()
        {
        ...
        {
            var ndcContextType = FindType("Serilog.Context.LogContext", new[] {"Ducky.Logging", "Serilog.FullNetFx"});
        ...
        private static Type GetLogManagerType()
            => FindType("Serilog.Log", "Ducky.Logging");
    ...
    [ExcludeFromCodeCoverage]
        ...
        internal class SerilogLogger
        {
            ...
            private static bool Initialize()
            {
                try
                {
                    var logEventLevelType = FindType("Serilog.Events.LogEventLevel", "Ducky.Logging");
                    ...
                    var loggerType = FindType("Serilog.ILogger", "Ducky.Logging");
